...
| `tx` | WP9 | ✅ | `TxV1` (v3) fixed-layout codec, binding digest **transcript-bound into the spend proof** ([security review](security-review.md) F-1), malleability + uniformity tests, stateless validation |
